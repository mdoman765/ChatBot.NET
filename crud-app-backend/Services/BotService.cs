        ...
        private async Task<string> HandleStatusCheckAsync(BotSession s, IncomingMessage msg)
        {
            ...
            var L = s.Lang == "bn"
                ? (title: "টিকেট স্ট্যাটাস", id: "টিকেট আইডি",
                   status: "স্ট্যাটাস", date: "জমা দেওয়া হয়েছে",
            ...
            if (!result.Success)
            {
                ...
                return complaintType == "agent_connect"
                    ...
                    : s.T(
                        ...
                        $"❌ জমা দেওয়া ব্যর্থ হয়েছে।\n\n{errMsg}\n\nঅনুগ্রহ করে আবার চেষ্টা করুন — পুনরায় জমা দিতে *Y* পাঠান অথবা বাতিলের জন্য *N* পাঠান।");
            }
